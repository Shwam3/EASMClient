...
public class SignalMap
{
    ...
    private void initNorwich()
    {
        ...
        Signals.getOrCreateSignal(bpNorwich, 1574, 214, "CC0570", "CC9B:3", RIGHT);
        Signals.getOrCreateSignal(bpNorwich, 1574, 174, "CC0572", "CC9B:4", RIGHT);
    ...
    private void initClacton()
    {
        ...
        Signals.getOrCreateSignal(bpClacton, 476,  350, "CC1102", "CC06:2", RIGHT);
        ...
        Signals.getOrCreateSignal(bpClacton, 846,  318, "CC1121", "CC05:7", LEFT);
        ...
        Signals.getOrCreateSignal(bpClacton, 872,  326, "CC1128", "CC12:2", RIGHT);
        Signals.getOrCreateSignal(bpClacton, 990,  318, "CC1133", "CC12:7", LEFT);
    ...
    private void initColchester()
    {
        ...
        Signals.getOrCreateSignal(bpColchester, 986,  718, "CC1073", "CC44:8", SignalPostDirection.TEST);
